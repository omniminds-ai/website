...
<!--              <span>Download</span>-->
<!--            </a>-->
<!--            &lt;!&ndash; <div class="mt-1 text-xs text-gray-500">-->
    ...
    <div class="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2">
      ...
      <div class="rounded-xl bg-white p-6">
        <div class="mb-4 flex items-start">
          ...
          <div class="ml-4">
            <h3 class="text-lg font-semibold text-gray-900">The Arena</h3>
      ...
      <div class="rounded-xl bg-white p-6">
        <div class="mb-4 flex items-start">
          ...
          <div class="ml-4">
            <h3 class="text-lg font-semibold text-gray-900">The Dojo</h3>
            <p class="mt-2 text-gray-600">
